...
class ArchiveCardOrderList extends GetView<OrdersArchiveController> {
  const ArchiveCardOrderList({super.key, required this.listModel});
          ...
          children: [
            ...
            Row(
              children: [
                ...
                if (listModel.ordersRating == "0")
                  MaterialButton(
                    color: AppColor.thirdColor,
                    textColor: AppColor.secoundColor,
                    onPressed: () {
                      showDialogRating(context, listModel.ordersId!);
                    },
